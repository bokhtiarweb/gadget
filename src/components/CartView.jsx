...
function CartView({item}) {
  const {removeFromCart} = useContext(CreatedContext);
  ...
  return (
    <>
        <div className='bg-[#ffffff] rounded-xl p-6'>
            ...
            <p onClick={() => removeFromCart(item.product_id)} className='text-3xl cursor-pointer text-red-600'><IoMdClose></IoMdClose></p>
